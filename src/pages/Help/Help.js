			...
			<Accordion defaultActiveKey={[""]} alwaysOpen="false">
				<Accordion.Item eventKey="0">
					...
					<Accordion.Body>
						<ol>
							<li>
								Click on "Add Recipe" in the navigation bar or
							...
							<br />
							<li>
								Enter in all of the ingredients for the recipe.
							...
							<ul>
								...
								<li>
									...
									the lower left corner of the ingredients
							...
							<ul>
								...
								<li>
									...
									the lower left corner of the instructions
						...
						<ol>
							...
							<ul>
								<li>
									...
									every page and compares the search query
									against Recipe Titles.
								</li>
								<li>
									Search is not case-sensitive and can do
									partial matches.
								</li>
							</ul>
							<br />
							...
							<ul>
								<li>
									The My Recipes link in the navigation bar or
									the My Recipes button on the home page will
									display a list of all recipes in
									alphabetical order.
								</li>
								<li>
									Using this method, finding a recipe may
					...
					<Accordion.Body>
						<ul>
							<li>
								...
								buttons for keeping track of ingredients and
								steps completed.
							</li>
							<br />
							<li>
								Clicking the green check mark button will put a
							...
							<br />
							<li>
								Some of our users like to cross off ingredients
								as they are gathered to the workspace and others
								like to cross them off as the ingredients are
								used. Feel free to experiment!
							</li>
						</ul>
					</Accordion.Body>
				</Accordion.Item>
				<Accordion.Item eventKey="3">
					...
					<Accordion.Body>
						<ol>
							<li>
								First, navigate to the recipe using your
								favorite method.
							</li>
							<br />
							...
							<li>
								Make any edits that are necessary and when
								finished press the "Update" button.
							</li>
							<li>
								To cancel an unintentional edit, press the
								"Cancel" button.
							</li>
							<br />
				...
				<Accordion.Item>
					...
					<Accordion.Body>
						<ol>
							...
							<li>
								Confirm the deletion when the modal window pops
								up.
							</li>
							<li>
